...
using namespace std;
//This is the class of boundary incidence contains member functons to perform various operaions realted to incidence of light.
class WavePropagation{
    ...
    void get(){
        system("color 5");
        label:
        cout<<"\nEnter value of refrective index of first medium ";
        cin>>n1;
        if(n1<=0||!cin){
            fflush(stdin);
            cin.clear();
            ...
            goto label;}
            lnew:
        cout<<"\nEnter value of refractive index of second medium";
        cin>>n2;
        if(n2<=0||!cin){
            fflush(stdin);
            cin.clear();
    ...
    void normal(){
        ...
        float r=(n1-n2)/(n1+n2);
        float t=(2*n1)/(n1+n2);
        cout<<"\nThe value of raito of Er to Ei is:"<<r;
        cout<<"\nThe value of raito of Et to Ei is:"<<t;
        cout<<"\nThe value of Reflectance(R) is:"<<r*r;
        cout<<"\nThe value of Transmittance(T) is:"<<(n2/n1)*t*t;
        cout<<"\nAs the sum of R and T is 1 , So Conservation of enery is proved.";
    }
    //For electric field is perpendicular to plane of incidence
    void oblique1(){
        system("color 6");
        float in;
        float ref;
        ...
        if(in==90||!cin){
            ...
            ln:
        in=in*pi/180;
        cout<<"\nEnter angle of refraction in degrees:";
        cin>>ref;
        if(ref==90||!cin){
            fflush(stdin);
            cin.clear();
            ...
            goto ln;}
        ref=ref*pi/180;
        float r=(n1*cos(in)-n2*cos(ref))/(n1*cos(in)+n2*cos(ref));
        float t=(2*n1*cos(in))/(n1*cos(in)+n2*cos(ref));
        cout<<"\nThe value of raito of Er to Ei is:"<<r;
        cout<<"\nThe value of raito of Et to Ei is:"<<t;
        cout<<"\nThe value of Reflectance(R) is:"<<r*r;
        cout<<"\nThe value of Transmittance(T) is:"<<((n2*cos(ref))/(n1*cos(in)))*t*t;
        cout<<"\nAs the sum of R and T is 1 , So Conservation of enery is proved.";
    }
      //For electric field is parallel to plane of incidence
     void oblique2(){
         system("color 9");
        float in;
        float ref;
        ...
        if(ref==90||!cin){
            ...
            goto labelne;}
        ref=ref*pi/180;
        float r=(n2*cos(in)-n1*cos(ref))/(n2*cos(in)+n1*cos(ref));
        float t=(2*n1*cos(in))/(n2*cos(in)+n1*cos(ref));
        cout<<"\nThe value of raito of Er to Ei is:"<<r;
        cout<<"\nThe value of raito of Et to Ei is:"<<t;
        cout<<"\nThe value of Reflectance(R) is:"<<r*r;
        cout<<"\nThe value of Transmittance(T) is:"<<((n2*cos(ref))/(n1*cos(in)))*t*t;
...
class Fiberoptics{
    ...
    //To calculate numerical aperture of fiber, i.e.; light gathering capacity of fiber.
    void NA(){
        system("color 2F");
...
void CR(){
    ...
    l3:
    cout<<"\nEnter the value for diameter index of core in centi-meters:"<<endl;
    ...
    cout<<"\ncritical radius of your singlemode fiber is:"<<critical_radius<<" "<<"centi-meters"<<endl;
}
}
...
system("color 4");
system("cls");
cout<<"\n\n\n\n\n1:Wave Propagation \n2:For Fiberoptics calculation\n3:Exit\nEnter choice:";
cin>>x;
if(!cin){
            fflush(stdin);
            cin.clear();
            Beep(300,500);
            cout<<"Wrong input! Press enter to choose again";
            getchar();
            continue;}
...
switch(x){
    case 1:
        label:
        system("color 9F");
        cout<<"\n\n1:For the case of Normal incidence \n2: For the case of Oblique incidence:\nEnter choice:";
        cin>>choice;
        if(!cin){
            fflush(stdin);
            cin.clear();
        ...
        switch(choice){
            ...
            case 1:
                ...
                break;
            case 2:
                cout<<"\n1:For Electric field is perpendicular to place of incidence \n2:For Electric field is parallel to plane of incidence\nEnter choice:";
                cin>>obliquecase;
                switch(obliquecase){
                    case 1:
                        B.get();
...
//Respected sir , this project is formed by me with great dedication.
